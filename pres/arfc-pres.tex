...
\author[Oleksandr Yardas]{Oleksandr Yardas \inst{1}\\
Paul Romano \inst{2} \and Madicken Munk
\inst{3} \and Kathryn Huff \inst{1}}
%\date[short date]{long date}
\date[07.09.2025]{July 9, 2025}
%\institution[short name]{long name}
\institute[UIUC]{\inst{1} University of Illinois Urbana-Champaign
    \and \inst{2} Argonne National Laboratory \and
\inst{3} Oregon State University}
...
\input{compuer_problem}
\subsection{Nuclear Basics}
\input{nuclear_basics}
\section{Methods}
\subsection{Modeling Depletion}
\input{modeling_depletion}
