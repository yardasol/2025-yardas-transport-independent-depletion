        ...
        \begin{columns}
            \column[t]{5cm}
               \begin{itemize}
                    ...
                    \item Each fuel element is unique (recall the ATR, Fig
                        \ref{fig:atr})
                    \item Axial discretization can add several orders of
                        magnitude $\rightarrow$ days of calculation on a cluster
                \end{itemize}
