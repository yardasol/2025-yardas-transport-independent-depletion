\section{Results}\label{sec:results}
    ...
    using a 3-day time step underpredicts the \ce{^{241}Pu} concentration, but at
    ...
    that are related to the amount of \ce{^{241}Pu}, such as Cm and Am. We
    ...
    nuclides (\ce{U}, \ce{^{239}Np}, \ce{^{239}Pu}, \ce{^{240}Pu}) tend to have
    low concentration errors, (5\% or less), whereas the less important
    actinides (Am, Cm, \ce{^{241}Pu}, \ce{^{242}Pu}) tend to have very high
