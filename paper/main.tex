...
\begin{abstract}
    ...
    that enables transport-independent depletion. This feature relies on using
    OpenMC calculate multigroup cross sections and fluxes that are reused at
    every depletion step. These reaction rates determined by the cross sections
    and fluxes are used to deplete materials using the existing algorithms in
    OpenMC's Python API.
    ...
    concentration and difficulty to produce accurately using multi-group cross
    sections.
